      ...
      <div className="flex flex-col py-8 md:py-[4%] md:flex-row w-[90%] mx-auto h-fit justify-between items-center">
        ...
        <div className="w-full md:w-[55%]">
          ...
          <h6 className="pt-5 md:pb-[2%] font-[NeueHaasDisplay400] font-normal">
            ...
            is one of India’s leading Career Coaches with over 80 Global clients
            across 54 countries. He has impacted over 30,000 professionals
            worldwide with his{" "}
            <span className="text-[#FF914D] font-[NeueHaasDisplayBold] font-bold">
            ...
            He is a{" "}
            <span className="text-[#FF914D] font-[NeueHaasDisplayBold] font-bold">
              2x TEDx Speaker, 5X LinkedIn top voice and a serial entrepreneur.
            </span>
          </h6>
        </div>
      </div>
